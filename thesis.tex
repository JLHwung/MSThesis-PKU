...
% 草稿模式
% \documentclass[UTF8, colorlinks, adobefonts, CheckSingle, CJKnumber, draft]{pkuthss}
% 截稿
\documentclass[UTF8, colorlinks, adobefonts, CheckSingle]{pkuthss}
...
\setCJKsansfont[BoldFont=Lantinghei SC Demibold]{Lantinghei SC Extralight}
\setCJKmonofont{Adobe Fangsong Std}

\setCJKfamilyfont{zhhei}[BoldFont=Lantinghei SC Demibold]{Lantinghei SC Extralight}
\setCJKfamilyfont{zhsong}{FZNewShuSong-Z10}
